...
@section('content')
    ...
    <div class="page-content-wrap" style="margin-top: 10px;">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="widget widget-default widget-item-icon">
                    ...
                    <div class="widget-data">
                        <div class="widget-int num-count"><a href="/provider/orders/urgent">{{$monthly_orders_count}}</a></div>
            ...
            <div class="col-md-3">
                ...
                <div class="widget widget-default widget-item-icon">
                    ...
                    <div class="widget-data">
                        <div class="widget-int num-count"><a href="/provider/orders/urgent">{{$monthly_open}}</a></div>
            ...
            <div class="col-md-3">
                ...
                <div class="widget widget-default widget-item-icon">
                    ...
                    <div class="widget-data">
                        <div class="widget-int num-count"><a href="/provider/orders/urgent">{{$monthly_closed}}</a></div>
            ...
            <div class="col-md-3">
                ...
                <div class="widget widget-default widget-item-icon">
                    ...
                    <div class="widget-data">
                        <div class="widget-int num-count"><a href="/provider/orders/canceled">{{$monthly_canceled}}</a></div>
        ...
        <div class="row">
            ...
            @if(provider()->hasPermissionTo('statistics_financial'))
                <div class="col-md-3">
                    <!-- START WIDGET -->
                    <div class="widget widget-default widget-item-icon">
                        <div class="widget-item-left">
