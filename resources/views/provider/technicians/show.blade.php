                ...
                <form action="#" class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <p>
                                @if($technician->active == 1)
                                    <span class="label label-success label-form"> Active Technician </span>
                                @elseif($technician->active == 0)
                                    <span class="label label-primary label-form"> Suspended Technician </span>
                                @endif
                            </p>
            ...
            <div class="col-md-6 col-sm-8 col-xs-7">
                ...
                <form action="#" class="form-horizontal">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body form-group-separated">
                            <div class="form-group">
                                <label class="col-md-3 col-xs-5 control-label">Categories</label>
                                <div class="col-md-9 col-xs-7">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 col-xs-5 control-label">Appearance average</label>
                                <div class="col-md-9 col-xs-7">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 col-xs-5 control-label">Cleanliness average</label>
                                <div class="col-md-9 col-xs-7">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 col-xs-5 control-label">Performance average</label>
                                <div class="col-md-9 col-xs-7">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 col-xs-5 control-label">Commitment average</label>
                                <div class="col-md-9 col-xs-7">
                    ...
                    <div class="panel-body form-horizontal form-group-separated">
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-xs-6">
                                <a href="/provider/technician/{{$technician->id}}/edit"><button class="btn btn-warning">Edit</button></a>
                            </div>
                        </div>
                        @if($technician->active == 1)
                            <div class="form-group">
