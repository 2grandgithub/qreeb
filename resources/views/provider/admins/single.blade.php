                                    ...
                                    <div class="col-md-6 col-xs-12">
                                        <div class="input-group">
                                            <select class="form-control select" name="role" id="role_select" data-style="btn-success" required>
                                                ...
                                                @foreach($roles as $role)
                                                    <option value="{{$role->name}}" @if(isset($admin) && $admin->hasRole('provider_'.$role->name)) selected @endif>{{$role->slogan}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        @if(isset($admin))
                                            <div class="permission">
                                                @foreach($permissions['provider_'.$admin->role] as $permission)
