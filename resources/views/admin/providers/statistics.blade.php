...
@section('content')
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="/admin/providers/active">Providers</a></li>
        <li><a href="/admin/provider/{{$provider->id}}/view">{{$provider->en_name}}</a></li>
    ...
    <div class="page-content-wrap">
        ...
        <div class="row">
            ...
            @if(admin()->hasPermissionTo('providers_observe_statistics_financial'))
                <div class="col-md-3">
                    <!-- START WIDGET -->
                    <div class="widget widget-default widget-item-icon">
                        <div class="widget-item-left">
