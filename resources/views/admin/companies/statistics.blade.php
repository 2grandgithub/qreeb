...
@section('content')
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="/admin/companies/active">Providers</a></li>
        <li><a href="/admin/company/{{$company->id}}/view">{{$company->en_name}}</a></li>
    ...
    <div class="page-content-wrap">
        ...
        <div class="row">
            ...
            @if(admin()->hasPermissionTo('companies_observe_statistics_financial'))
                <div class="col-md-3">
                    <!-- START WIDGET -->
                    <div class="widget widget-default widget-item-icon">
                        <div class="widget-item-left">
