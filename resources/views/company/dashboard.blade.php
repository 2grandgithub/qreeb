        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="widget widget-default widget-item-icon">
                    ...
                    <div class="widget-data">
                        <div class="widget-int num-count"><a href="/company/orders/urgent">{{$monthly_orders_count}}</a></div>
            ...
            <div class="col-md-3">
                ...
                <div class="widget widget-default widget-item-icon">
                    ...
                    <div class="widget-data">
                        <div class="widget-int num-count"><a href="/company/orders/urgent">{{$monthly_open}}</a></div>
            ...
            <div class="col-md-3">
                ...
                <div class="widget widget-default widget-item-icon">
                    ...
                    <div class="widget-data">
                        <div class="widget-int num-count"><a href="/company/orders/urgent">{{$monthly_closed}}</a></div>
            ...
            <div class="col-md-3">
                ...
                <div class="widget widget-default widget-item-icon">
                    ...
                    <div class="widget-data">
                        <div class="widget-int num-count"><a href="/company/orders/canceled">{{$monthly_canceled}}</a></div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="widget widget-default widget-item-icon">
                    ...
                    <div class="widget-data">
                        <div class="widget-int num-count"><a href="/company/orders/re_scheduled">{{$monthly_parts_orders_count}}</a></div>
            ...
            <div class="col-md-3">
                ...
                <div class="widget widget-default widget-item-icon">
                    ...
                    <div class="widget-data">
                        <div class="widget-int num-count"><a href="/company/orders/re_scheduled">{{$monthly_parts_count}}</a></div>
            ...
            @if(company()->hasPermissionTo('statistics_financial'))
                <div class="col-md-3">
                    ...
                    <div class="widget widget-default widget-item-icon">
                        ...
                        <div class="widget-data">
                            <div class="widget-int num-count"><a href="/company/orders/re_scheduled">{{$monthly_parts_prices}} S.R</a></div>
