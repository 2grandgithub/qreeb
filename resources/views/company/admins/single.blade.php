    ...
    <div class="page-content-wrap">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form class="form-horizontal" method="post" action="{{isset($admin) ? '/company/admin/update' : '/company/admin/store'}}" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                                    ...
                                    <div class="col-md-6 col-xs-12">
                                        <div class="input-group">
                                            <select class="form-control select" name="role" id="role_select" data-style="btn-success" required>
                                                ...
                                                @foreach($roles as $role)
                                                    <option value="{{$role->name}}" @if(isset($admin) && $admin->hasRole('company_'.$role->name)) selected @endif>{{$role->slogan}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        @if(isset($admin))
                                            <div class="permission">
                                                @foreach($permissions['company_'.$admin->role] as $permission)
                            ...
                            <div class="form-group {{ $errors->has('badge_id') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="badge_id" value="{{isset($admin) ? $admin->badge_id : old('badge_id')}}" required/>
